...
class Traffic_generator:
    ...
    def write_data(self, run):    
        ...
        cbengine_data_path = self.data_folder + 'CBEngine_'+str(run+1) + '_flow.txt'
        self.fl.output_cbengine(output_path=cbengine_data_path)
        cityflow_data_path = self.data_folder + 'Cityflow_'+str(run+1) + '_flow.json'
        self.fl.output_cityflow(output_path=cityflow_data_path)
        sumo_data_path = self.data_folder + 'SUMO_'+str(run+1) + '_flow.xml'
        ...
        cfg_folder = self.main_folder + "/cfg/"
